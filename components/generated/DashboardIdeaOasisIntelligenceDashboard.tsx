...
interface DashboardIdeaOasisIntelligenceDashboardProps {
  className?: string;
}
...
export function DashboardIdeaOasisIntelligenceDashboard({ className }: DashboardIdeaOasisIntelligenceDashboardProps) {
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Dashboard: IdeaOasis Intelligence Dashboard</CardTitle>
